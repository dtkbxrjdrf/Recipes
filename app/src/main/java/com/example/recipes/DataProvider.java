...
public class DataProvider {
    static LinkedList<RecipeList> recipes;

    static LinkedList<RecipeList> getRecipes() {
        return recipes;
    }

    static {
        recipes = new LinkedList<RecipeList>();
        ...
        recipes.add(new RecipeList(name, description, image, ingredients, directions));
